...
> A curated collection of Django projects demonstrating Django mastery.
...
- Projects are numbered to track progress.

- ✅ Ready to Run indicates a virtual environment exists.

- ❌ Not ready to run means you need to create a venv first.
